    ...
    <main className="pt-12">
      <section className="relative flex flex-col justify-center min-h-[50vh] lg:min-h-[1000px] w-screen pb-16">
        <div className="relative mx-auto h-full flex flex-col justify-between items-center text-center">
          ...
          <h1
            ref={titleRef}
            className="wb text-4xl lg:text-6xl font-light mb-20"
          >
            <span className="block wb text-4xl sm:text-6xl lg:text-6xl 2xl:text-7xl mb-4 tex-[#70e000] uppercase drop-shadow-xl stroke">
              ONE. TWO. PUFF.
            </span>
          </h1>
          <div
            ref={subtitleRef}
            className="w-full flex justify-center items-center h-40 mb-24"
          >
            <button className="block mx-auto">
              <CirclePlay
                strokeWidth={0.75}
                size={96}
                className="hover:stroke-[#70e000]"
              />
            </button>
          </div>
        </div>
      ...
      <section className="min-h-96 w-screen pb-16">
        <div
          ref={subCardsRef}
          className="w-full lg:w-4/5 px-6 mx-auto grid grid-cols-1 lg:grid-cols-4 gap-x-6 text-center"
        >
        ...
        <div className="lg:w-1/3 mx-auto text-center py-12">
          <Link href="/pro" className="block w-fit mx-auto mb-4">
            <h2 className="text-xl font-semibold underline underline-offset-4 hover:no-underline">
